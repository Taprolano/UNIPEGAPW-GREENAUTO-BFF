# GreenAuto S.p.A. – Educational Project (BFF)
...
This repository contains the **Backend for Frontend (BFF)** for the GreenAuto S.p.A. project. It is a Node.js application that exposes APIs and acts as an intermediary between the frontend and external data sources.
